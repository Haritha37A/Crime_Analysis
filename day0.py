...
# Clean data: Remove rows with missing 'victim_sex' and 'weapon_description'
df = df.dropna(subset=['victim_sex', 'weapon_description'])
st.write("Cleaned DataFrame after removing rows with missing 'victim_sex' and 'weapon_description':")
st.write(df.head())
...
# Preprocessing: Convert date columns to datetime and extract month and year
